...
class Group(BaseGroup):
    ...
    info_item1 = models.StringField(
        choices=['פרויקט C שלילי בקריטריון 1',
                 'פרויקט D חיובי בקריטריון 1',
                 'פרויקט B חיובי בקריטריון 2',
                 'פרויקט C שלילי בקריטריון 2',
                 'פרויקט E שלילי בקריטריון 2',
                 'פרויקט A חיובי בקריטריון 3',
                 'פרויקט D שלילי בקריטריון 3',
                 'פרויקט C שלילי בקריטריון 4',
                 'פרויקט D חיובי בקריטריון 4',
                 'פרויקט A שלילי בקריטריון 5',
                 'פרויקט B חיובי בקריטריון 5',
                 'פרויקט C חיובי בקריטריון 5',
                 'פרויקט D שלילי בקריטריון 5',
                 'פרויקט E חיובי בקריטריון 5',
                 'פרויקט B חיובי בקריטריון 6'],
        label="איזה פריט מידע תבחרו לשתף?",
    )

    info_item2 = models.StringField(
        choices=['פרויקט A שלילי בקריטריון 1',
                 'פרויקט B שלילי בקריטריון 1',
                 'פרויקט C שלילי בקריטריון 1',
                 'פרויקט D חיובי בקריטריון 1',
                 'פרויקט C שלילי בקריטריון 2',
                 'פרויקט E שלילי בקריטריון 2',
                 'פרויקט B שלילי בקריטריון 3',
                 'פרויקט E חיובי בקריטריון 3',
                 'פרויקט B שלילי בקריטריון 4',
                 'פרויקט D חיובי בקריטריון 4',
                 'פרויקט A שלילי בקריטריון 5',
                 'פרויקט C חיובי בקריטריון 5',
                 'פרויקט A שלילי בקריטריון 6',
                 'פרויקט B חיובי בקריטריון 6',
                 'פרויקט E שלילי בקריטריון 6'],
        label="איזה פריט מידע תבחרו לשתף?",
    )
    info_item3 = models.StringField(
        choices=['פרויקט B שלילי בקריטריון 1',
                 'פרויקט C שלילי בקריטריון 1',
                 'פרויקט E חיובי בקריטריון 1',
                 'פרויקט A חיובי בקריטריון 2',
                 'פרויקט B חיובי בקריטריון 2',
                 'פרויקט D שלילי בקריטריון 2',
                 'פרויקט E שלילי בקריטריון 2',
                 'פרויקט A חיובי בקריטריון 3',
    ...
    info_item4 = models.StringField(
        choices=['פרויקט A שלילי בקריטריון 1',
                 ...
                 'פרויקט A חיובי בקריטריון 4',
                 'פרויקט D חיובי בקריטריון 4',
                 'פרויקט E חיובי בקריטריון 4',
                 'פרויקט A שלילי בקריטריון 5',
                 'פרויקט B חיובי בקריטריון 5',
                 'פרויקט C חיובי בקריטריון 5',
                 'פרויקט B חיובי בקריטריון 6',
                 'פרויקט C חיובי בקריטריון 6',
                 'פרויקט D שלילי בקריטריון 6',
                 'פרויקט E שלילי בקריטריון 6'],
        label="איזה פריט מידע תבחרו לשתף?",
    )
        ...
        if player.round_number == C.NUM_ROUNDS:
            ...
            if player_in_selected_round.correct_in_round:
                player_in_selected_round.payoff = C.ENDOWMENT + (
                        C.ENDOWMENT * player_in_selected_round.level_of_confidence / 100)
            else:
                player_in_selected_round.payoff = C.ENDOWMENT - (
                        C.ENDOWMENT * player_in_selected_round.level_of_confidence / 100)
