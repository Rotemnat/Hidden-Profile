...
class C(BaseConstants):
    NAME_IN_URL = 'share_information1221'
    PLAYERS_PER_GROUP = 4
    NUM_ROUNDS = 8
    ENDOWMENT = cu(50)
...
class Group(BaseGroup):
    info_item1 = models.StringField(
        choices=['פרויקט A חיובי בקריטריון 1',
                 ...
                 'פרויקט C שלילי בקריטריון 3',
                 'פרויקט D חיובי בקריטריון 3',
                 'פרויקט A חיובי בקריטריון 4',
                 'פרויקט B חיובי בקריטריון 4',
                 'פרויקט E חיובי בקריטריון 4',
                 'פרויקט B שלילי בקריטריון 5',
...
class Input(Page):
    ...
    def vars_for_template(player: Player):
        ...
        base_number = 1
        pic_address = 'app1221/infoset{}.{}.png'.format(base_number, id_in_group)
        return dict(
