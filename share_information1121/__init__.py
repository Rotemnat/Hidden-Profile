...
class Group(BaseGroup):
    info_item1 = models.StringField(
        choices=['פרויקט C חיובי בקריטריון 1',
    ...
    info_item3 = models.StringField(
        choices=['פרויקט A שלילי בקריטריון 1',
                 'פרויקט B שלילי בקריטריון 1',
                 'פרויקט C חיובי בקריטריון 1',
                 'פרויקט D חיובי בקריטריון 1',
                 'פרויקט D שלילי בקריטריון 2',
                 'פרויקט E חיובי בקריטריון 2',
                 'פרויקט C שלילי בקריטריון 3',
                 'פרויקט E חיובי בקריטריון 3',
                 'פרויקט C חיובי בקריטריון 4',
                 'פרויקט A חיובי בקריטריון 5',
...
class Player(BasePlayer):
    ...
    correct_in_round = models.BooleanField(initial=False)
