...
class C(BaseConstants):
    NAME_IN_URL = 'choice1111'
    PLAYERS_PER_GROUP = 4
    NUM_ROUNDS = 1
    PAYOFF = cu(150)
    OPTIMAL_OPTION = 'פרויקט A'
    SUBOPTIML_OPTION1 = 'פרויקט B'
...
def set_payoffs(group: Group):
    ...
    if group.votes_for_optimal > 2:
        ...
        Player.potential_payoff = C.PAYOFF
...
class Introduction12(Page):
    pass

class Introduction13(Page):
    pass

class Introduction15(Page):
    pass

class Introduction16(Page):
    pass

class Introduction17(Page):
    pass

class Introduction18(Page):
    pass

class Introduction19(Page):
    pass
...
page_sequence = [Introduction12, Introduction13, MyPage14, Introduction15, Introduction16, Introduction17, Introduction18, Introduction19, Introduction20]